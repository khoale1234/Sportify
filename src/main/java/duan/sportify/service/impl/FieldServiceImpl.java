...
public class FieldServiceImpl implements FieldService{
	...
	@Override
	public Boolean checkAvailableByTimeAndDate(String fieldName, int shiftId, String playDate){
		Field fieldAvai=fieldDAO.findAvailableFieldsByShiftAndDate(fieldName,shiftId,playDate);
		if (fieldAvai == null) {
			return true;
		}
		return false;
	...
	@Override 
	public List<Field> suggestFields(String username){
